    ...
    <div className="cartProduct flex w-full justify-between items-center border-b border-zinc-800 py-3 px-5">
      ...
      <div className="cartProductRight flex items-center gap-10">
        <div className="quantity flex gap-4 items-center">
          <div onClick={()=> quantity > 1 && setquantity(quantity-1)} className="w-[2vw] h-[2vw] bg-zinc-800 rounded-full flex items-center justify-center">
            <i className="ri-subtract-line"></i>
          </div>
          <div>{quantity}</div>
          <div onClick={()=> setquantity(quantity+1)} className="w-[2vw] h-[2vw] bg-zinc-800 rounded-full flex items-center justify-center">
